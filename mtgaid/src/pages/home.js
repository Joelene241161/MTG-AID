  ...
  return (
    <body class="bodyBG">
     <section>
      ...
      <p class="bodyText">Here you can get interesting insights on Magic: The Gathering Cards. You can compare the stats of two random cards on our comparison page.</p>
